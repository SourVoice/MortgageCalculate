...
BEGIN_EVENT_TABLE(ProvidentFundLoan, wxDialog)
    EVT_COMBOBOX(ID_CHOICE_CALCULATE_TYPE,                                      ProvidentFundLoan::OnSetCalculateType)
    EVT_COMBOBOX(ID_CHOICE_INTEREST_TYPE,                                       ProvidentFundLoan::OnSetInterestType)


    EVT_COMBOBOX(ID_CHOICE_LTV,                                                 ProvidentFundLoan::OnSetLoanToValue)
    EVT_COMBOBOX(ID_CHOICE_LTY,                                                 ProvidentFundLoan::OnSetMonth)

    EVT_TEXT(ID_TEXTCTRL_HOUSE_SQUARE,                                          ProvidentFundLoan::OnSetHouseSquare)
    EVT_TEXT(ID_TEXTCTRL_HOUSE_PRICE,                                           ProvidentFundLoan::OnSetHousePrice)
    EVT_TEXT(ID_TEXTCRTL_TOTAL_LOAN,                                            ProvidentFundLoan::OnSetTotalLoan)

    EVT_CHECKBOX(ID_CHECKBOX_REPAYTYPE_PRINCIPAL_INTEREST,                      ProvidentFundLoan::OnSetRepayType)
    EVT_CHECKBOX(ID_CHECKBOX_REPAYTYPE_PRINCIPAL,                               ProvidentFundLoan::OnSetRepayType)

    EVT_BUTTON(ID_BUTTON_ACTION,                                                ProvidentFundLoan::OnActionButton)
    EVT_BUTTON(ID_BUTTON_CLEAR,                                                 ProvidentFundLoan::OnClearButton)
END_EVENT_TABLE()
ProvidentFundLoan::ProvidentFundLoan(wxFrame* Frame)
    :wxDialog(Frame, wxID_ANY, 
        wxT("ProvidentFundLoan"),
...

{
    ...
    */
    ...
    ChosenType_ShowInterest = new wxTextCtrl(this, ID_TEXTCTRL_CHOSEN_TYPE_SHOW_INTEREST, "3.25", wxDefaultPosition, wxDefaultSize);
...
void ProvidentFundLoan::OnSetCalculateType(wxCommandEvent& event)
{
...
void ProvidentFundLoan::OnSetInterestType(wxCommandEvent& event)
{
        switch (event.GetSelection()) {
        case 1:
            ChosenType_ShowInterest->SetValue("3.25");                       //string_IT.Add(wxT("基准利率"));
            break;
        case 2:
            ChosenType_ShowInterest->SetValue("2.28");                      //string_IT.Add(wxT("基准利率下限（7折）"));
            break;
        case 3:
            ChosenType_ShowInterest->SetValue("5.39");                      //string_IT.Add(wxT("基准利率上限（1.1倍）"));
            break;
        case 4:
            ChosenType_ShowInterest->SetValue("3.41");                      //string_IT.Add(wxT("基准利率上限（1.05倍）"));
            break;
        case 5:
            ChosenType_ShowInterest->SetValue("2.76");                      //string_IT.Add(wxT("基准利率下限（85折）"));
            break;
        default:
            break;
        }
...
void ProvidentFundLoan::OnSetRepayType(wxCommandEvent& event)
{
...
void ProvidentFundLoan::OnSetHousePrice(wxCommandEvent& event)
{
...
void ProvidentFundLoan::OnSetHouseSquare(wxCommandEvent& event)
{
...
void ProvidentFundLoan::OnSetTotalLoan(wxCommandEvent& event)
{
...
void ProvidentFundLoan::OnSetLoanToValue(wxCommandEvent& event)                                                //按揭成数
{
    double InitialValue = 0.8;
    LoanToValue = InitialValue - 0.05 * event.GetSelection();
}

void ProvidentFundLoan::OnSetMonth(wxCommandEvent& event)                                                      //还款次数
{                                                                                                           //还款期限（month）
    double InitialValue = 360;
    Months = InitialValue - 12 * event.GetSelection();
}

void ProvidentFundLoan::OnGetInterestResult()                                                                  //显示计算所得年利率
{
    if (!ChosenType_ShowInterest->GetLineText(0).ToDouble(&ResultIntersetRate)) {
        /*error*/
    }
	ResultIntersetRate /= 100;

}

void ProvidentFundLoan::OnActionButton(wxCommandEvent& event)
{
    ///*处理checkbox异常*/
...
void ProvidentFundLoan::OnClearButton(wxCommandEvent& event)
{
    InputPrice->Clear();
    InputSquare->Clear();
    InputTotalLoan->Clear();
...
void ProvidentFundLoan::ProcessDataByPrinciple()
{
...
void ProvidentFundLoan::ProcessDataByInterest()                                            //等额本息
{
...
void ProvidentFundLoan::ResultByPricipalDialog()
{
...
//等额本息
void ProvidentFundLoan::ResultByInterestDialog()
{
    wxDialog* ReaultDialog = new wxDialog(this, wxID_ANY,
        wxT("结果"), wxDefaultPosition, wxDefaultSize);
    wxBoxSizer* colSizer = new wxBoxSizer(wxVERTICAL);
...
void ProvidentFundLoan::ProcessInputPriceError()
{
    ...
    dialog_NotInputHousePrice->Bind(wxEVT_WINDOW_MODAL_DIALOG_CLOSED,
        &ProvidentFundLoan::MessageBoxWindowModalClosed, this);
    dialog_NotInputHousePrice->ShowWindowModal();
}

void ProvidentFundLoan::ProcessInputSquareError()
{
...
void ProvidentFundLoan::ProcessInputTotalLoanError()
{
...
void ProvidentFundLoan::ProcessCheckBoxError()
{
...
void ProvidentFundLoan::ProcessInputPriceEmptyError()
{
    wxMessageDialog* dialog_NotInputHousePrice = new wxMessageDialog(this,                             //给予用户提示
        "This is a message box",
        "Message box text",
    ...
    {
        extmsg = "You didn't Input The House Price,\n"
...
void ProvidentFundLoan::ProcessInputSquareEmptyError()
{
    wxMessageDialog* dialog_NotInputHouseSquare = new wxMessageDialog(this,                             //给予用户提示
        "This is a message box",
        "Message box text",
        wxCENTER |
        wxNO_DEFAULT | wxYES_NO | wxCANCEL |
    ...
    {
        extmsg = "You didn't Input The House Square,\n"
            "Please Input The Number.";
    }
    else
    {
...
void ProvidentFundLoan::ProcessInputTotalLoanEmptyError()
{
    wxMessageDialog* dialog_NotInputTotalLoan = new wxMessageDialog(this,                             //给予用户提示
        "This is a message box",
        "Message box text",
...
void ProvidentFundLoan::MessageBoxWindowModalClosed(wxWindowModalDialogEvent& event)
{
